...
Blockly.BlockSvg.prototype.onMouseUp_ = function(e) {
  ...
  /*
  type3 da:
  function(source, type_0){
      Blockly.RenderedConnection.superClass_.constructor.call(this, source, type_0);
      this.offsetInBlock_ = new goog_0.math.Coordinate(0, 0);
    }

  alert("type1: " + (Blockly.localConnection_ instanceof Blockly.RenderedConnection));
  alert("type2: " + (Blockly.localConnection_ instanceof Blockly.Connection));
  alert("type3: " + (Blockly.localConnection_.constructor));*/
};
 ...
 * Select this block.  Highlight it visually.
 */
Blockly.BlockSvg.prototype.highlight = function() {
  Blockly.utils.addClass(/** @type {!Element} */ (this.svgGroup_),
                    'blocklySelected');
